...
dbutils.widgets.text("root_folder", "lakehouse-retail-churn", "Demo root folder")
dbutils.widgets.text("catalog", "hive_metastore", "UC catalog")
dbutils.widgets.text("cloud_storage_path", "/demos", "Data Storage")
...
raw_data_location = cloud_storage_path+"/retail/lakehouse_churn/"+catalog
...
if not catalog_exists and catalog != "hive_metastore":

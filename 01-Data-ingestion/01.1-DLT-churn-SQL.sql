...
-- display(spark.read.json('/demos/retail/churn/orders'))
select * from json.`/demos/retail/churn/orders`
...
USING csv 
OPTIONS (
  path '/demos/retail/churn/events',
  header true
);

select * from events
-- display(spark.read.csv('/demos/retail/churn/events', header=True))
